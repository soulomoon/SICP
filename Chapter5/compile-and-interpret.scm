; the new interpreter to first compile go and then interpret


(load "/Users/soulomoon/git/SICP/material/allcode/load-eceval-compiler.scm")

(define (go-two expression in-exp)
  (let ((instructions
         (assemble (statements
